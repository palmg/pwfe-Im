...
var ChatFrame = function (_React$Component) {
    ...
    _createClass(ChatFrame, [{
        ...
        value: function componentDidMount() {
            ...
            var hisList = this.props.onHistory();
            var msgList = [];
        ...
        value: function historyHandle() {
            ...
            try {
                for (var _iterator2 = hisList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function setChatList(chatList) {
            ...
            try {
                for (var _iterator3 = chatList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
