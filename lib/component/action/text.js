...
var cn = require('classnames/bind').bind(require('./text.scss'));
...
var Text = function (_React$Component) {
    ...
    _createClass(Text, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('textarea', { ref: function ref(_ref2) {
                    _this2.dom = _ref2;
                }, onKeyUp: this.keyUpHandle, className: cn('text'), placeholder: '\u8BF7\u8F93\u5165\u804A\u5929\u4FE1\u606F' });
        }
    }]);
