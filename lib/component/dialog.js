...
var cn = require('classnames/bind').bind(require('./dialog.scss'));
...
var Dialog = function (_React$Component) {
    ...
    function Dialog() {
        ...
        return _possibleConstructorReturn(this, (_ref = Dialog.__proto__ || Object.getPrototypeOf(Dialog)).call.apply(_ref, [this].concat(props)));
    }
    ...
    _createClass(Dialog, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: cn('dialog'), ref: function ref(_ref2) {
                        _this2.dom = _ref2;
                    } },
                chatList && chatList.map(function (i) {
                    switch (i.type) {
                        ...
                        case _context.chatType.receive:
                            return _react2.default.createElement(_receive2.default, { key: 'Receive' + i.timestamp, user: user, chat: i.msg, timestamp: i.timestamp });
                        default:
